...
public class SupplyManagementModel implements DataManagementModel {
    ...
    private static final SupplyManagementModel instance = new SupplyManagementModel();        // Singleton per SupplyManagementModel
    ...
    private final SupplierManagementModel supplierManagement = SupplierManagementModel.getInstance();

    private SupplyManagementModel() {              // Costruttore privato per evitare la creazione di nuove istanze (Singleton) e per estrapolare il prossimo codice fornitura
    ...
    public static SupplyManagementModel getInstance() {
        return instance;
    }
