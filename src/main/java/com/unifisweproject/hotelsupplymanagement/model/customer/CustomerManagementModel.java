package com.unifisweproject.hotelsupplymanagement.model.customer;
...
public class CustomerManagementModel implements DataManagementModel {

    private static final CustomerManagementModel instance = new CustomerManagementModel();           // Singleton
    ...
    private CustomerManagementModel() {                                                                   // Il costruttore inizializza il contenuto della variabile nextItemCode
    ...
    public static CustomerManagementModel getInstance() {
        return instance;
    }

    @Override
    public void loadFromDB() throws SQLException {          // Caricamento dei dati del DB sui clienti nella lista di CustomerManagementModel
