...
public class OrderManagementModel implements DataManagementModel {

    private static final OrderManagementModel instance = new OrderManagementModel();        // Singleton
    private int nextOrderCode;               // Tiene traccia del codice dell'ultimo Ordine nel DB
    private final ArrayList<Order> orderList = new ArrayList<>();
    private final CustomerManagementModel customerManagement = CustomerManagementModel.getInstance();

    private OrderManagementModel() {                                                                   // Il costruttore inizializza il contenuto della variabile nextItemCode
        nextOrderCode = getLastOrderCode();
    }

    public static OrderManagementModel getInstance() {
        return instance;
    }
