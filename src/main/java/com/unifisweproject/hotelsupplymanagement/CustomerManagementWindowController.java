...
public class CustomerManagementWindowController implements Initializable {
    ...
    public void displayAddView() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("CustomerAddWindow.fxml"));
    ...
    public void displayCustomerView(ActionEvent ignoredEvent) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("CustomerDisplayWindow.fxml"));
            Parent root = loader.load();
    ...
    public void displaySearchView(ActionEvent ignoredEvent) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("CustomerSearchWindow.fxml"));
            Parent root = loader.load();
