...
public class CustomerDataManagementController implements DataManagementController {
    ...
    public void initializeRows()  {
        ...
        ObservableList<Customer> customerRows = FXCollections.observableArrayList(customerManagement.getCustomerList());
        customerManagementView.setRows(customerRows);
    ...
    public void modifyRow(ActionEvent event, Customer displayedCustomer) {

        modifyCompanyAndContactDetails(displayedCustomer);
        ...
        try {
            ...
            displayedCustomer.setNome(customerName);
            displayedCustomer.setCognome(customerSurname);
            displayedCustomer.setCodice_fiscale(customerFiscalCode);
            displayedCustomer.setData_inserimento(date.toString());
            displayedCustomer.setSconto(Integer.parseInt(discount));
            customerManagement.modify(displayedCustomer);
    ...
    public void updateTable() {
        ...
        if(searchView) {
            ...
            customerManagementView.setRows(searchResultRows);
        }
        else {
            ObservableList<Customer> customerRows = FXCollections.observableArrayList(customerManagement.getCustomerList());
            customerManagementView.setRows(customerRows);
    ...
    public void searchRow(ActionEvent event) {
        ...
        if (toBeSearched != null) {
            ...
            try {
                ...
                customerManagementView.enableBackButton();
            }
    ...
    public void handleActionEvent(ActionEvent event) {
        ...
        if (event.getSource() instanceof Button button) {
            switch (button.getId()) {
                ...
                case "backButton" -> customerManagementView.exitSearch();
                case "modifyButton" -> {
