...
import com.unifisweproject.hotelsupplymanagement.customer.CustomerAddWindowController;
import com.unifisweproject.hotelsupplymanagement.main.HotelSupplyManagementMain;
import com.unifisweproject.hotelsupplymanagement.supplier.SupplierAddWindowController;
...
public class ContactDetailsAddWindowController implements Initializable {
    ...
    public void confirmData(ActionEvent event) {
        ...
        try {
            ...
            if (customerAddWindowController != null)                                                                                          // Serve per capire quale finestra ha richiamato quella di aggiunta dei dettagli sul recapito
                customerAddWindowController.setContactDetails(addressField.getText(), CAPField.getText(), civicNumberField.getText());
            if (supplierAddWindowController != null)
                supplierAddWindowController.setContactDetails(addressField.getText(), CAPField.getText(), civicNumberField.getText());
