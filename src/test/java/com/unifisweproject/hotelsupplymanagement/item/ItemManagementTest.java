...
public class ItemManagementTest {
    ...
    static ItemManagementModel itemManagement;
    ...
    static void setUp() {                   // Codice di set-up per la connessione al DB e l'inserimento di un articolo di test
        ...
        try {
            ...
            itemManagement = ItemManagementModel.getInstance();
    ...
    @Test
    void testAddItem() {                // Test per il metodo addItem in ItemManagementModel: effettuo l'aggiunta di un articolo e successivamente verifico che i dati siano stati inseriti correttamente
    ...
    @Test
    void testModifyItem() {         // Test per il metodo modifyItem in ItemManagementModel: effettuo la modifica di un articolo e successivamente verifico che i dati siano stati modificati correttamente
    ...
    @Test
    void testSearchItem() {             // Test per il metodo search in ItemManagementModel: effettuo una ricerca di un articolo e verifico che il risultato sia corretto
